...
Gem::Specification.new do |gem|
  ...
  gem.summary     = "FIXME: New project p2"
  gem.description = "FIXME: New project p2"
  gem.authors     = ["arvicco"]
  gem.email       = "arvitallian@gmail.com"
  gem.homepage    = "http://github.com/arvicco/p2"
  ...
  # RDoc setup
  gem.has_rdoc = true
  gem.rdoc_options.concat %W{--charset UTF-8 --main README.rdoc --title p2}
